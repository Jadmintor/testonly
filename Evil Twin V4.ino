...
<body class="text-white">
    <nav class="glass-effect sticky top-0 z-50 p-4">
        <div class="container mx-auto flex items-center justify-between">
            ...
            <div class="flex items-center space-x-6" id="nav-buttons">
...
.text-white { color: #fff; } /* Explicitly define if not using a full framework */
.container {
    width: 100%;
    margin-left: auto;
    margin-right: auto;
...
.lg\:grid-cols-2 { /* For large screens and up */
    @media (min-width: 1024px) {
        grid-template-columns: repeat(2, minmax(0, 1fr));
    }
}
.lg\:grid-cols-4 { /* For large screens and up */
    @media (min-width: 1024px) {
...
.border-l-blue-500 { border-left-color: #3b82f6; } /* Specific for selected network */
...
/* Specific button colors (if not using full Tailwind) */
...
/* Active tab styling */
.nav-item.active-tab {
    background-color: var(--dark-card); /* Or a distinct color */
    color: var(--text-primary);
...
.nav-item.active-tab:hover {
    background-color: var(--dark-card); /* Keep same background on hover for active tab */
}
